...
function categorizeCountries(keyword) {
  ...
  if (keyword == 'land') {
   ...
   countries.filter((name) => name.endsWith('land'))
      console.log(name)}
  // } else if (keyword == 'way') {
  //     console.log(countryName.filter((country) => country.endsWith('way')))
  // } else if (keyword =='en') {
  //     console.log(countryName.filter((country) => country.endsWith('en')))
  // }else if (keyword =='ia') {
  //   console.log(countryName.filter((country) => country.endsWith('ia')))
  // }else if (keyword =='stan') {
  //   console.log(countryName.filter((country) => country.endsWith('stan')))
  // }else if (keyword =='island') {
  //   console.log(countryName.filter((country) => country.endsWith('island')))
   }else {
...
//   const patternList = ['land', 'ia', 'island', 'stan'];
...
//         categorizedCountries.push(countryName);
//         break;
//       }
//     }
//   }
