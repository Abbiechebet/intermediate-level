...
# Write your solution below
  # Take user input
animal_choice = int(input("Enter the number of the animal you want to learn about: "))

  # Validate user input
if 1 <= animal_choice <= len(descriptions):
      print(descriptions[animal_choice - 1])
else:
      print("Invalid choice. Please enter a number between 1 and", len(descriptions))
